...
var State = function (ecVotes, abbrev, capsName, fullname, id) {
	this.electoralCollegeVotes = ecVotes;
...
var inittheStates = function () {
  ...
  theStates.push(new State(9, "AL", "ALABAMA", "Alabama", ++i));
  ...
  theStates.push(new State(3, "AK", "ALASKA", "Alaska", ++i));
  ...
  theStates.push(new State(11, "AZ", "ARIZONA", "Arizona", ++i));
  ...
  theStates.push(new State(6, "AR", "ARKANSAS", "Arkansas", ++i));
  ...
  theStates.push(new State(55, "CA", "CALIFORNIA", "California", ++i));
  ...
  theStates.push(new State(3, "DE", "DELAWARE", "Delaware", ++i));
  ...
  theStates.push(new State(3, "DC", "DISTRICT OF COLUMBIA", "District of Columbia", ++i));
  g_StateMap["DC"] = theStates[i];
  theStates[i].polys.push(new poly());
  theStates[i].polys[0].ptX = [730, 720, 710, 720, 730];
  theStates[i].polys[0].ptY = [270, 280, 270, 260, 270];
  theStates.push(new State(29, "FL", "FLORIDA", "Florida", ++i));
  ...
  theStates.push(new State(16, "GA", "GEORGIA", "Georgia", ++i));
  ...
  theStates.push(new State(4, "HI", "HAWAII", "Hawaii", ++i));
  ...
  theStates.push(new State(4, "ID", "IDAHO", "Idaho", ++i));
  ...
  theStates.push(new State(20, "IL", "ILLINOIS", "Illinois", ++i));
  ...
  theStates.push(new State(11, "IN", "INDIANA", "Indiana", ++i));
  ...
  theStates.push(new State(6, "IA", "IOWA", "Iowa", ++i));
  ...
  theStates.push(new State(6, "KS", "KANSAS", "Kansas", ++i));
  ...
  theStates.push(new State(8, "KY", "KENTUCKY", "Kentucky", ++i));
  ...
  theStates.push(new State(8, "LA", "LOUISIANA", "Louisiana", ++i));
  ...
  theStates.push(new State(4, "ME", "MAINE", "Maine", ++i));
  ...
  theStates.push(new State(10, "MD", "MARYLAND", "Maryland", ++i));
  ...
  theStates.push(new State(11, "MA", "MASSACHUSETTS", "Massachusetts", ++i));
  ...
  theStates.push(new State(16, "MI", "MICHIGAN", "Michigan", ++i));
  ...
  theStates.push(new State(10, "MN", "MINNESOTA", "Minnesota", ++i));
  ...
  theStates.push(new State(6, "MS", "MISSISSIPPI", "Mississippi", ++i));
  ...
  theStates.push(new State(10, "MO", "MISSOURI", "Missouri", ++i));
  ...
  theStates.push(new State(3, "MT", "MONTANA", "Montana", ++i));
  ...
  theStates.push(new State(5, "NE", "NEBRASKA", "Nebraska", ++i));
  ...
  theStates.push(new State(6, "NV", "NEVADA", "Nevada", ++i));
  ...
  theStates.push(new State(4, "NH", "NEW HAMPSHIRE", "New Hampshire", ++i));
  ...
  theStates.push(new State(14, "NJ", "NEW JERSEY", "New Jersey", ++i));
  ...
  theStates.push(new State(5, "NM", "NEW MEXICO", "New Mexico", ++i));
  ...
  theStates.push(new State(29, "NY", "NEW YORK", "New York", ++i));
  ...
  theStates.push(new State(15, "NC", "NORTH CAROLINA", "North Carolina", ++i));
  ...
  theStates.push(new State(3, "ND", "NORTH DAKOTA", "North Dakota", ++i));
  ...
  theStates.push(new State(18, "OH", "OHIO", "Ohio", ++i));
  ...
  theStates.push(new State(7, "OK", "OKLAHOMA", "Oklahoma", ++i));
  ...
  theStates.push(new State(7, "OR", "OREGON", "Oregon", ++i));
  ...
  theStates.push(new State(20, "PA", "PENNSYLVANIA", "Pennsylvania", ++i));
  ...
  theStates.push(new State(4, "RI", "RHODE ISLAND", "Rhode Island", ++i));
  ...
  theStates.push(new State(9, "SC", "SOUTH CAROLINA", "South Carolina", ++i));
  ...
  theStates.push(new State(3, "SD", "SOUTH DAKOTA", "South Dakota", ++i));
  ...
  theStates.push(new State(11, "TN", "TENNESSEE", "Tennessee", ++i));
  ...
  theStates.push(new State(38, "TX", "TEXAS", "Texas", ++i));
  ...
  theStates.push(new State(6, "UT", "UTAH", "Utah", ++i));
  ...
  theStates.push(new State(3, "VT", "VERMONT", "Vermont", ++i));
  ...
  theStates.push(new State(13, "VA", "VIRGINIA", "Virginia", ++i));
  ...
  theStates.push(new State(12, "WA", "WASHINGTON", "Washington", ++i));
  ...
  theStates.push(new State(5, "WV", "WEST VIRGINIA", "West Virginia", ++i));
  ...
  theStates.push(new State(10, "WI", "WISCONSIN", "Wisconsin", ++i));
  ...
  theStates.push(new State(3, "WY", "WYOMING", "Wyoming", ++i));
